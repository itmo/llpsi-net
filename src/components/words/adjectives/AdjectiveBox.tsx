        ...
        <TableContainer component={Paper}>
            <Table size='small'>
                ...
                <TableBody>
                    ...
                    <AdjectiveEntry adj={props.adj} casus={Casus.Nominative} />
                    <AdjectiveEntry adj={props.adj} casus={Casus.Accusative} />
                    <AdjectiveEntry adj={props.adj} casus={Casus.Genitive} />
                    <AdjectiveEntry adj={props.adj} casus={Casus.Dative} />
                    <AdjectiveEntry adj={props.adj} casus={Casus.Ablative} />
                    <AdjectiveEntry adj={props.adj} casus={Casus.Vocative} />
                </TableBody>
            </Table>
        </TableContainer>
        <ul>
...
const AdjectiveEntry: React.FunctionComponent<{adj: Adjective, casus: Casus}> = (props) =>
    <StyledTableRow>
